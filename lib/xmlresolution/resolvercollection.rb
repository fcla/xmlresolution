...
module XmlResolution
  ...
  class ResolverCollection
    ...
    def get_resolution_data(filepath)
      ...
      #
      # FILENAME test.xml
      # SCHEMA c703435da3490c8bbd58b69fad125017 2009-05-05T14:40:48-04:00 http://www.loc.gov/standards/mets/mets.xsd   http://www.loc.gov/METS/
      # SCHEMA 54fbb3ef95c5f2f0d89a9c755e9b616e 2007-07-27T15:12:52-04:00 http://www.fcla.edu/dls/md/daitss/daitss.xsd   http://www.fcla.edu/dls/md/daitss/ 
      # SCHEMA 446839f319de8d5b40871c9da8f99c37 2006-06-16T14:39:11-04:00 http://www.fcla.edu/dls/md/palmm.xsd   http://www.fcla.edu/dls/md/palmm/
      # SCHEMA a166f873a7607ebcec83c01354f300af 2004-09-29T17:30:36-04:00 http://www.fcla.edu/dls/md/techmd.xsd   http://www.fcla.edu/dls/md/techmd/
      # SCHEMA 86a5c9c8c17b91c97be61847218fe823 2004-09-29T17:30:36-04:00 http://www.fcla.edu/dls/md/rightsmd.xsd   http://www.fcla.edu/dls/md/rightsmd/
      # SCHEMA afd985136a7e721cfafa062287a27f45 2009-11-03T13:34:01-05:00 http://dublincore.org/schemas/xmls/simpledc20021212.xsd   http://purl.org/dc/elements/1.1/
      ...
      XmlResolution.read_lock(filepath) do |fd|
        fd.readlines.each do |line|
          data = XmlResolution.unescape(line.chomp)
          case data.shift
          when 'FILENAME'       
    ...
    def save_resolution_data(document_text, filename)
      ...
      XmlResolution.write_lock(resolution_data_pathname) do |fd|
        fd.puts XmlResolution.escape('FILENAME',  filename)
        begin
          rez = XmlResolver.new(document_text, proxy)
        rescue => e
          fd.puts XmlResolution.escape('RESOLUTION_FAILURE', e.message)
        else
          save_and_note_schema_files(rez.schema_information)  do |digest, location, namespace, mtime, schema_pathname|
            fd.puts XmlResolution.escape('SCHEMA', digest, location, namespace, schema_pathname, mtime.iso8601)
          end
          fd.puts XmlResolution.escape('UNRESOLVED_NAMESPACES', *rez.unresolved_namespaces)      
          report_broken_schemas(rez.schema_information) do |location, namespace, reason|
            fd.puts XmlResolution.escape('BROKEN_SCHEMA', location, namespace, reason)
          end
        end
      end   # of write_lock
