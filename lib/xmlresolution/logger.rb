...
# TODO:  the whole prefix thing is lame - rip it out, and rip out the @env environment requirement.
...
class Logger
  ...
  def Logger.filename= filepath
    ...
    ResolutionUtils.check_directory "The log directory", File.dirname(filepath)
